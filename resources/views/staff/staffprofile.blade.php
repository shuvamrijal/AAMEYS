                      ...
                      <div class="col-lg-4">
                        <div class=" profile-sidebar-portlet">
                          <div class="profile-img">
                              <form class="" action="{{route('staff.saveimage')}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                          ...
                          <div class="account_list" style="margin-top:20px;">
                            <ul class="nav nav-tabs" id="account_list">
                              ...
                              <li><a data-toggle="tab"  href="#account"><i class="fas fa-user"></i> Account</a> <i class="fas fa-angle-right"></i></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <div class="" style="margin:0px">
                                            <form method="post" action="{{route('staff.profile.edit')}}" style="marrgin:0px;"  >
                                              {{csrf_field()}}
                                              ...
                                              <div class="row">
                                                <div class="col-lg-offset-0 col-lg-10 col-xs-12 col-sm-10">
                                                  <div class="form-group">
                                                    ...
                                                    <textarea name="qualification" class="form-control" rows="8" cols="80">{{$row['qualification']}}</textarea>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="row">
                                      ...
                                      <div class="username col-sm-12">
                                          ...
                                          <div id="usernamerow">
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="{{Auth::guard('staff')->user()->email}}">
                                                    </div>
                                                    <div class="col-sm-2">
                                          ...
                                          <form class="" action="{{route('staff.changeusername')}}" method="post">
                                              {{csrf_field()}}
                                            <div class="form-group row">
                                                    <label for="staticEmail" class="col-sm-3 col-form-label">Email:</label>
                                                    <div class="col-sm-7">
                                                      <input type="text"  name="email" class="form-control" value="{{Auth::guard('staff')->user()->email}}">
                                                    </div>
                                            </div>
                                            <div class="form-group row">
                                              <div class="col-sm-3">
                                                <input type="hidden" name="id" value="{{Auth::guard('staff')->user()->id}}">
                                              </div>
